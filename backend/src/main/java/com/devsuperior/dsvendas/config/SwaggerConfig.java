...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.devsuperior.dsvendas.controllers"))
	...
	private static Contact contact() {
		return new Contact("Gabriela Ribeiro", "https://github.com/gabsribeiro", "g.sribeiro@gmail.com");
	}
